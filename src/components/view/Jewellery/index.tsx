...
const Jewellery = () => {
    return (
        <div className="px-1">
            {/* top */}
            <div className="flex justify-start md:justify-end text-4xl text-5xl font-bold py-4">
            ...
            <div className="flex flex-col md:flex-row justify-between py-4 mt-2 gap-5">
                ...
                <div className="relative basis-1/2 gap-6 lg:gap-10 grid grid-cols-2 grid-rows-2">
                    <div className="absolute inset-0 text-slate-200">
                        <h6 className="text-5xl md:text-7xl lg:text-[7.5rem] leading-[5.9rem] font-bold absolute -z-20 text-gray-100">Different from others</h6>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row basis-1/2">
                    <div className='w-full px-4 lg:px-0 lg:w-80'>
                        <Image width={1000} height={1000} alt={"designer jewellery"} src={"https://full-stack-ecommerce-clothing-web.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ffeature.1118a2f3.png&w=384&q=75"} />
                    </div>
                    <div className='space-y-6 md:space-y-4 p-6'>
                        <p style={{wordSpacing:"0.8rem"}} className='h-[90%] max-w-[15rem]'>
