...
const ProductTypes = () => {
  return (
    <div className="py-16 px-2 space-y-5">
      ...
      {/* Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 px-2 text-gray-800 py-4">
        {/* first grid */}
        ...
        <div className="py-9 text-white  w-full col-auto md:col-span-2  bg-cat2 flex flex-col justify-center items-center space-y-3" >
          <h2 className="font-extrabold text-4xl">GET 30% Off</h2>
          <p>USE PROMO CODE</p>
          <button
            aria-label='Redirect user to Dine Week End Sale'
            className='py-1 px-8 text-lg font-medium bg-btn rounded-lg tracking-widest'
